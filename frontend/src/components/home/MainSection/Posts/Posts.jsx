...
function Posts() {
  return (
    <div className="= bg-white shadow-[0_10px_30px_rgb(0,0,0,0.2)] p-5 rounded-xl flex flex-col gap-8 max-sm:mb-[70px]">
      ...
      <Post
        text={
          "  Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam sequimollitia sed tenetur in, possimus laborum repudiandae praesentium voluptates tempora facere sapiente ullam voluptatem neque nisi quam Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam sequimollitia sed tenetur in, possimus laborum repudiandae praesentium voluptates tempora facere sapiente ullam voluptatem neque nisi quamLorem ipsum dolor sit amet consectetur adipisicing elit. Numquam sequimollitia sed tenetur in, possimus laborum repudiandae praesentium voluptates tempora facere sapiente ullam voluptatem neque nisi quam"
        }
